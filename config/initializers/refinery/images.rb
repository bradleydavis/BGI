...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"800x800>"}
  ...
  # config.dragonfly_secret = "f863bd25fa41d6294554b1cf7713096ac7eb5ecb51c69cef"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/edwinrozario/Git/Sites/BGI-refinery/public/system/refinery/images"
